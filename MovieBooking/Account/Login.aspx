...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <asp:LinkButton ID="btnLogin1" runat="server" class="btn btn-primary btn-user btn-block" Text="Login" OnClick="btnLogin_Click">
    ...
    <div class="modal fade" id="dvVerifyOTP" role="dialog">
        <div class="modal-dialog modal-sm" style="z-index: 1052;">
            <!-- Modal content-->
            <div class="modal-content" style="width: 300px;">
                ...
                <div class="modal-body" style="overflow: auto; min-height: 100px !important; min-width: 150px;">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group marT10">
                                <label>Enter OTP</label>
                                <asp:TextBox runat="server" ID="txtOTP" CssClass="form-control" MaxLength="50" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <asp:Button runat="server" ID="btnVerifyOTP" OnClick="btnVerifyOTP_Click" CssClass="btn btn-primary" Text="Submit" />
